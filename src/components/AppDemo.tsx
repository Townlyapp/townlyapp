  ...
  return <section id="app-demo" className="py-24 relative">
      ...
      <div className="section-container relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 reveal-on-scroll">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Esplora la demo</h2>
          ...
          <div className="order-1 lg:order-2 animate-fade-in-right">
            <div className="space-y-8">
              ...
              <div className="flex flex-col space-y-4">
                {screens.map((screen, index) => <div key={index} className={cn("p-4 rounded-lg cursor-pointer transition-all duration-300 flex items-center", activeScreen === index ? "bg-townly-orange/10 border border-townly-orange/20" : "hover:bg-gray-100")} onClick={() => setActiveScreen(index)}>
