        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center reveal-on-scroll">
          ...
          <div className="order-2 lg:order-1 animate-fade-in-left delay-200">
            ...
            >
              ...
              <div className="flex items-center justify-center mt-4 gap-2">
                <button 
                  className="p-2 text-townly-orange hover:bg-townly-orange/10 rounded-full transition"
                  onClick={() => {
                    document.querySelector('#app-demo [data-carousel-prev]')?.dispatchEvent(
                ...
                <button 
                  className="p-2 text-townly-orange hover:bg-townly-orange/10 rounded-full transition"
                  onClick={() => {
                    document.querySelector('#app-demo [data-carousel-next]')?.dispatchEvent(
                      new MouseEvent('click', { bubbles: true })
                    );
                  }}
                >
          ...
          <div className="order-1 lg:order-2 animate-fade-in-right">
            <div className="space-y-8">
                ...
                {screens.map((screen, index) => (
                  <div 
                    ...
                    className={cn(
                      ...
                      activeScreen === index 
                        ? "bg-townly-orange/10 border border-townly-orange/20" 
                        : "hover:bg-gray-100"
                    )}
                    onClick={() => {
                      ...
                      if (diff > 0) {
                        ...
                        for (let i = 0; i < diff; i++) {
                          setTimeout(() => {
                            carousel?.dispatchEvent(new MouseEvent('click', { bubbles: true }));
                          }, i * 100);
                        }
                      } else if (diff < 0) {
              ...
              <a 
                href="#contact" 
                className="inline-flex items-center text-townly-orange font-medium hover:underline mt-4"
              >
