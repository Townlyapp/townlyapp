    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button variant="outline" size="icon" className="relative">
          ...
          {totalItems > 0 && (
            <Badge className="absolute -top-2 -right-2 h-5 w-5 rounded-full p-0 flex items-center justify-center text-xs bg-townly-orange hover:bg-townly-orangeDark">
              {totalItems}
            </Badge>
          )}
        </Button>
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col h-full">
        <SheetHeader className="flex-shrink-0">
          ...
          <SheetDescription>
            {totalItems === 0 ? "Il tuo carrello è vuoto" : `${totalItems} esperienza${totalItems !== 1 ? '' : ''} nel carrello`}
          </SheetDescription>
        </SheetHeader>
            ...
            <>
                  ...
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-2 border rounded-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-semibold text-townly-orange">
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t bg-background">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-townly-orange">
